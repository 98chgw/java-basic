...
//
//        int a; //필드 (맴버 변수) => 객체 생성 시 자동으로 초기화 됨.
//        void printNumber(int c){ //매개변수
//            int b = 10; //지역변수 -> 반드시 초기화를 수동으로 해야함
//            System.out.println("a = " + a); //필드
//            System.out.println("b = " + b); //지역변수
//            System.out.println("c = " + c); //매개변수
//        }
//        void foo () {
//            System.out.println("a = " + a); //필드는 어느 메서드에서든 참조 가능함
//
//        }
//    }
//}
